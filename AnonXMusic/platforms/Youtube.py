...
# ============== CONFIGURE YOUR API ==============
YOUR_API_URL = "http://64.227.167.178:8000"
YOUR_API_KEY = "ishq_mein"
# ================================================
...
class YouTubeAPI:
    ...
    async def video(self, link: str, videoid: Union[bool, str] = None):
        ...
        return (1, file_path) if file_path else (0, "API download failed")
    ...
    async def track(self, link: str, videoid: Union[bool, str] = None):
        try:
            ...
            async with httpx.AsyncClient(timeout=15) as client:
                resp = await client.get(f"{YOUR_API_URL}/search", params=params, headers=headers)
    ...
    async def download(
        ...
        if songvideo:
            return await get_file_from_api(video_id, audio=False), True
        elif songaudio or not video:
            return await get_file_from_api(video_id, audio=True), True
        elif video:
            return await get_file_from_api(video_id, audio=False), True
        else:
            return await get_file_from_api(video_id, audio=True), True
